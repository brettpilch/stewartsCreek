...
class Widget
{
  ...
  Widget(String t, String l, int x, int y, int w, int h)
  {
    pos = new PVector(x, y);
...
class Button extends Widget
{
  ...
  Button(String nm, String l, int x, int y, int w, int h)
  {
    super(nm, l, x, y, w, h);
  }
...
class Toggle extends Button
{
  ...
  Toggle(String nm, String l, int x, int y, int w, int h)
  {
    super(nm, l, x, y, w, h);
  }
...
class Slider extends Widget
{
  ...
  Slider(String nm, String l, float v, float min, float max, int x, int y, int w, int h, int ori)
  {
    super(nm, l, x, y, w, h);
    val = v;
    minimum = min;
...
class textLink
{
  ...
  textLink(String nm, String u, float xloc, float yloc)
  {
    name = nm;
    url = u;
    x = xloc;
  ...
  void mouseReleased()
  {
    if (mouseX > x - textWidth(name) && mouseX < x + textWidth(name) &&
    mouseY < y && mouseY > y - textAscent() && !url.equals("None")){
      link(url);
    }
  }
}
